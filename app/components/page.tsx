...
export default function Home() {
  const [productList, setProductList] = useState<Task[]>([]);
  ...
  const handleAddProduct = async () => {
    ...
    try {
      ...
      const newProduct: Task = { ...formData, id: response.data.id };
  ...
  return (
    <div className="p-8 bg-gray-100 dark:bg-background dark:text-foreground">
      <h1 className="text-center text-2xl font-bold underline underline-offset-4 mb-6">Liste des Produits</h1>
